...
class _CommentScreenState extends State<CommentScreen> {
  ...
  bool validateComment(TextEditingController controller) {
    if (controller.text.isEmpty || controller.text.length > 1000 || controller.text.length < 3) {
      setState(() {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                errorText: _commentColor == Colors.red ? 'Komentar nije okay, mora imati min 1 slovo i max 1000' : null,
              ),
